...
<head>
    ...
    <title>C.C. MakeUp-Tecnología</title>
                ...
                ?>
                        ...
                        <div class="col">
                            <div class="card shadow-sm">
                                ...
                                $imagen = "../images/productos/tecnologia/" . $id . "/principal.jpg";
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group">
                                            <a href="../details/details_tecnologia.php?id=<?php echo $row['id']; ?>&token=<?php echo hash_hmac('sha1', $row['id'], KEY_TOKEN); ?>" class="btn btn-primary">Detalles</a>
                                        </div>
